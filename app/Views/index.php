...
<html lang="en">
    <head>
        ...
        <title>Rijal Paujiana</title>
        <link rel="icon" type="image/Profil" href="assets/img/Profil" />
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
            <a class="navbar-brand js-scroll-trigger" href="#page-top">
                <span class="d-block d-lg-none">Rijal Paujiana</span>
                <span class="d-none d-lg-block"><img class="img-fluid img-Profil rounded-circle mx-auto mb-2" src="assets/img/Profil.png" alt="..." /></span>
            </a>
        ...
        <div class="container-fluid p-0">
            ...
            <section class="resume-section" id="about">
                <div class="resume-section-content">
                    <h1 class="mb-0">
                        Rijal
                        <span class="text-primary">Paujiana</span>
                    </h1>
                    <div class="subheading mb-5">
                       Full adress: Kp.Kedung Rt/Rw 025/005 Desa Titisan Kec. Sukalarang Kab. Sukabumi
                          
                    </div>
                    <div class="subheading mb-5">
                        Place and Date of Birth: Sukabumi, 04 ocktober 1998
                    </div>
                    <div class="subheading mb-5">
                    ...
                    <div class="subheading mb-5">
                        Phone Nomber : 081299500048    
                    </div>
                    <div class="subheading mb-5">
                    Email : <a href="mailto:name@email.com">rijalpaujiana@gmail.com</a>
                    </div>
